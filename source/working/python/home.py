...
def makeHomeHTML():
    ...
    file.write('<div style="width: 100%; height: calc(70% - 60px); overflow-y: auto;">\n')
    file.write('<span style="font-size:30px;">Bucket List</span>')
    file.write(getBucketlist())
    file.write("</div>\n")
    file.write('<form action="/home" method="post" target="inner" style="margin-top: 10px; width: 100%; height: calc(30% - 60px);">\n')

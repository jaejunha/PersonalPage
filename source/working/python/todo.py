...
def makeTodoHTML(date):
    ...
    file.write('<div style="width: 100%; text-align: right;">\n')
    file.write('<a onclick="$(\'#dialog\').css(\'display\', \'none\');" style="margin-right: 5px; font-weight: bold; color: #f00; cursor: pointer;">X</a>\n')
    file.write("</div>\n")
    file.write("</div>\n")
    file.write("</div>\n")
